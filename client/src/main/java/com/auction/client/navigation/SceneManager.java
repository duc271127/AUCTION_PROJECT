...
public class SceneManager {
    ...
    public static void switchScene(String fxmlPath, String title, String... cssPaths) {
        try {
            ...
            Stage stage = requirePrimaryStage();
            ...
            LOGGER.log(Level.SEVERE, "Cannot switch scene to: " + fxmlPath, e);
        }
    }
    ...
    private static void addCss(Scene scene, String cssPath) {
        ...
        if (cssUrl == null) {
            LOGGER.warning("CSS not found, skipped: " + cssPath);
            return;
        }
        scene.getStylesheets().add(cssUrl.toExternalForm());
    }

    private static Stage requirePrimaryStage() {
